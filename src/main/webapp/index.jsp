<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
		...
		<header class="navbar">
			...
			<nav class="nav-links">
				<a href="home">Home</a> <a href="restaurants">Restaurants</a> <a href="#">Categories</a>
			...
			<div class="nav-actions">
				...
				<a href="#" class="login-btn" data-modal="login" id="nav-login-btn">
					Login </a> <a href="#" class="signup-btn" data-modal="signup" id="nav-signup-btn"> Sign Up </a>
			...
			<div class="mobile-menu" id="mobileMenu" role="navigation" aria-label="Mobile navigation">
				<ul class="mobile-nav-list">
					<li><a href="home" class="mobile-nav-link"> <span class="mobile-nav-icon"><i
									class="fa-solid fa-house"></i></span> <span class="mobile-nav-label">Home</span> <i
								class="fa-solid fa-chevron-right mobile-nav-arrow"></i>
						</a></li>
					<li><a href="restaurants" class="mobile-nav-link"> <span class="mobile-nav-icon"><i
									class="fa-solid fa-utensils"></i></span>
							<span class="mobile-nav-label">Restaurants</span> <i
								class="fa-solid fa-chevron-right mobile-nav-arrow"></i>
						</a></li>
					<li><a href="#" class="mobile-nav-link"> <span class="mobile-nav-icon"><i
									class="fa-solid fa-grid-2"></i></span>
							<span class="mobile-nav-label">Categories</span> <i
								class="fa-solid fa-chevron-right mobile-nav-arrow"></i>
						</a></li>
					<li><a href="#" class="mobile-nav-link"> <span class="mobile-nav-icon"><i
									class="fa-solid fa-tag"></i></span> <span class="mobile-nav-label">Offers</span> <i
								class="fa-solid fa-chevron-right mobile-nav-arrow"></i>
						</a></li>
					<li><a href="#" class="mobile-nav-link"> <span class="mobile-nav-icon"><i
				...
				<div class="mobile-menu-actions">
					<a href="#" class="mobile-login-btn" data-modal="login">Login</a> <a href="#"
						class="mobile-signup-btn" data-modal="signup">Sign Up
				...
				<div class="search-container">
					...
					<div class="location-field">
						...
						<div class="location-copy">
							...
							<textarea id="locationTextarea" placeholder="Enter delivery address..." rows="1"
								style="background: transparent; border: none; outline: none; color: var(--text); font-family: inherit; font-size: 1.18rem; font-weight: 700; width: 100%; resize: none; height: 28px; line-height: 1.2; padding: 0; margin: 0; display: block; overflow: hidden;">Whitefield, Bangalore</textarea>
						</div>
...
========================= -->
			...
			<div class="partner-container">
				...
				<div class="partner-illustration">
					...
					<div class="partner-image-wrapper">
						<img src="images/hero/rider.png" alt="Platter Partner Rider" class="rider-img">
					</div>
					...
					<div class="store-buttons-container">
						<a href="#" class="store-btn google-play-btn"> <i
							...
							<div class="store-btn-text">
								<span class="store-subtext">GET IT ON</span> <span class="store-maintext">Google
									Play</span>
							</div>
						</a> <a href="#" class="store-btn app-store-btn"> <i class="fa-brands fa-apple store-icon"></i>
							<div class="store-btn-text">
								<span class="store-subtext">Download on the</span> <span class="store-maintext">App
									Store</span>
							</div>
						</a>
					</div>
					...
					<div class="iphone-mockup">
						...
						<div class="iphone-screen">
							...
							<div class="iphone-app-banner">
								...
								<img src="images/hero/burger.png" alt="App Burger" class="app-banner-img">
							</div>
							...
							<div class="iphone-app-nav">
								<i class="fa-solid fa-house active"></i> <i class="fa-solid fa-magnifying-glass"></i> <i
									class="fa-solid fa-bag-shopping"></i> <i class="fa-solid fa-user"></i>
							</div>
						</div>
				...
				<div class="footer-links-grid">
					...
					<div class="footer-column social-column">
						...
						<div class="social-icons">
							<a href="#" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a> <a href="#"
								aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
							<a href="#" aria-label="YouTube"><i class="fa-brands fa-youtube"></i></a> <a href="#"
								aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
							<a href="#" aria-label="Twitter"><i class="fa-brands fa-x-twitter"></i></a>
						</div>
						<div class="footer-store-buttons">
							<a href="#" class="footer-store-btn"> <i class="fa-brands fa-apple"></i>
								<div class="btn-text">
									<span class="sub">Download on the</span> <span class="main">App
										Store</span>
								</div>
							</a> <a href="#" class="footer-store-btn"> <i class="fa-brands fa-google-play"></i>
								<div class="btn-text">
		...
		<!-- =====================================================
         LOGIN MODAL OVERLAY
         ===================================================== -->
		<div class="auth-modal-overlay" id="login-modal" role="dialog" aria-modal="true" aria-label="Login">
			<div class="auth-modal-card">
				...
				<div class="modal-logo-container">
					...
					<span class="modal-logo-text">Platter</span> <span class="modal-logo-tagline">Good Food, Great
						Mood</span>
				</div>
				...
				<form id="modal-login-form" action="login" method="post">
					...
					<div class="modal-input-group">
						...
						<div class="modal-input-wrapper">
							<input type="email" id="modal-login-email" name="email" placeholder="Enter your email"
								required> <i class="fa-regular fa-envelope modal-input-icon"></i>
						</div>
					</div>
					...
					<div class="modal-input-group">
						...
						<div class="modal-input-wrapper">
							...
							<button type="button" id="modal-login-toggle-pwd" class="modal-password-toggle"
					...
					<div class="modal-auth-actions">
						<label class="modal-checkbox-container"> <input type="checkbox" id="modal-remember-me"
								name="remember"> <span class="modal-checkmark"></span> Remember Me
						</label> <a href="#" class="modal-forgot-link">Forgot Password?</a>
					</div>

					<!-- Submit -->
					<button type="submit" class="modal-submit-btn">
						<span>Login</span> <i class="fa-solid fa-arrow-right modal-btn-arrow"></i>
					</button>
		...
		<!-- =====================================================
         ...
         ===================================================== -->
		<div class="auth-modal-overlay" id="signup-modal" role="dialog" aria-modal="true" aria-label="Sign Up">
			<div class="auth-modal-card signup-simple-card">

				<!-- Close Button -->
				<button class="modal-close-btn signup-close-btn" aria-label="Close signup modal">
					<i class="fa-solid fa-xmark"></i>
				</button>
				...
				<form id="modal-signup-form" action="signup" method="post">
					...
					<!-- Full Name -->
					<input type="text" id="modal-signup-name" name="name" class="signup-simple-input"
						placeholder="Full Name" required>

					<!-- Email -->
					<input type="email" id="modal-signup-email" name="email" class="signup-simple-input"
						placeholder="Email" required>

					<div class="modal-input-wrapper">
						<input type="password" id="modal-signup-password" name="password" class="signup-simple-input"
							placeholder="Password" required style="padding-right: 44px;">
						<button type="button" id="modal-signup-toggle-pwd" class="modal-password-toggle"
							aria-label="Toggle password">
							<i class="fa-regular fa-eye"></i>
						</button>
					</div>
					...
					<!-- Agreement -->
					<label class="signup-terms-label"> <input type="checkbox" id="modal-agree-terms" name="agree"
							required> <span class="signup-terms-box"></span> <span class="signup-terms-text">
					...
					<button type="submit" class="signup-create-btn" id="signup-create-btn" disabled>Create
						account</button>
